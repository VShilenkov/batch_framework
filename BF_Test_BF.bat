CALL :BF.BootStrap.Init & GOTO :%%BF_Start%%
...
::::::::::End of the original script file::::::::::
GOTO :eof

:: __RETURN : 1

:: __RETURN_MISSED_PARAM : 2

:: __RETURN_SUCCESS : 0

:: __RETURN_UNKNOWN : 1

:: BF.Exec.File : d:\Projects\batch_framework\BF_Test_BF.bat

:: BF.Param.String : -1 /2 "3" "4=2"

:: BF.Param[0] : d:\Projects\batch_framework\BF_Test.bat

:: BF.Script.Ext : .bat

:: BF.Script.File : d:\Projects\batch_framework\BF_Test.bat

:: BF.Script.Name : BF_Test

:: BF.Script.Path : d:\Projects\batch_framework\

:: BF.System.CmdLine : "C:\Windows\System32\cmd.exe" 

:: BF.Tmp.Ext : .tmp

:: BF.Tmp.File : d:\Projects\batch_framework\BF_Test_BF.tmp

:: BF.Tmp.Name : BF_Test_BF
