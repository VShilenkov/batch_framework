...
call :array dump A
echo.
echo Добавление к массиву A элементов из набора
call :array add A "'first line' 'Вторая строка' 12 54" !
call :array dump A
echo.
echo Поиск строки BAR
call :array find A "BAR" i
echo Найдено в позиции !_l!
echo.
echo Удаление элементов 3 5 8
call :array del A "3 5 8"
call :array dump A
echo.
echo Удаление элемента two
call :array find A Two i
call :array del A !_l!
call :array dump A
echo.
